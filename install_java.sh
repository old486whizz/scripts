...
#================================================================
#  install_java.sh does the following:
#     * installs java 1.6
#     * configures alternatives
#     * sets default java to official java
#   Assumptions:
#     * latest "rpm.bin" file in same dir
#================================================================
# Version: 1.0       08/12/2011       Paul "1" Sanders
#              Basic stuff. I rule,
...
VERSION="1.0"
JINST="`ls *rpm.bin |tail -1`"

echo "Installing RPMs using '${JINST}':"

./${JINST}
echo "Result: '$?'"
echo "\n------------------\n"

echo "Setting up JAVA alternative:"
...
echo "script has finished... Lord help us all!"
